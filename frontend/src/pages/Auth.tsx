...
import { X, ChevronLeft, Mail, Apple, MessageSquare, Phone, Fingerprint } from "lucide-react";
...
export default function Auth() {
  ...
  const handlePasskeyLogin = async () => {
    ...
    try {
      ...
      if (error.name !== "NotAllowedError" && error.message !== "Credential retrieval cancelled") {
        toast.error(error.message || "Failed to log in with passkey.");
      }
    } finally {
      setLoading(false);
    }
