...
serve(async (req) => {
    console.log("SHUFTI FUNCTION V4 - PAYLOAD FIX");
    ...
    try {
        ...
        // PAYLOAD V4: Minimal Valid Onsite Payload
        // - Removed 'country' entirely (optional)
        // - Removed 'allow_offline'/'allow_online' (might be invalid)
        // - Kept structure flat and clean
        const payload = {
