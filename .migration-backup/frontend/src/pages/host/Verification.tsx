...
const Verification = () => {
    ...
    // Auto-trigger redirect on verification success
    useEffect(() => {
        if (status === 'verified') {
            if (isRedirect) toast.success("Identity verified successfully!");
            const timer = setTimeout(() => (window.location.href = '/host'), 2000);
